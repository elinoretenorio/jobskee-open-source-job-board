...
//include_once $_SERVER['DOCUMENT_ROOT'] . '/jobskee/securimage/securimage.php';
include_once BASE_SECUREIMAGE . 'securimage/securimage.php';
	...
	if ($securimage->check($_POST['captcha_code']) == false) {
	  ...
	  echo "El código de seguridad ingresado es incorrecto.<br /><br />";
	  echo "Por favor <a href='javascript:history.go(-1)'>regresa</a> e intenta de nuevo.";
	  exit;
	}
